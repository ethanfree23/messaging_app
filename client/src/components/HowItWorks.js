                ...
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <div className="flex flex-col items-center justify-center p-10 w-full md:w-1/3 mb-8 md:mb-0">
                        <div className="text-center mb-4">
                            ...
                            <div className="absolute top-full -mt-1 left-1/2 transform -translate-x-1/2 w-full h-0.5 bg-blue-500"></div>
                        </div>
                        <div className="text-center mb-4">Setup & Onboard</div>
                        <div className="text-sm text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
                    </div>
                    {/* Step 2 */}
                    <div className="flex flex-col items-center justify-center p-10 w-full md:w-1/3 mb-8 md:mb-0">
                        <div className="text-center mb-4">
                        ...
                        <div className="text-sm text-gray-600">Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                    </div>
                    {/* Step 3 */}
                    <div className="flex flex-col items-center justify-center p-10 w-full md:w-1/3">
                        ...
                        <div className="text-sm text-gray-600">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                    </div>
                </div>
            </div>
        </div>
